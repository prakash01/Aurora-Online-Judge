...
function display_adminlogs(){
	...
	if($_SESSION["status"]=="Admin"){
		...
		$pagenav="";
		if($page>0) $pagenav.= "<a href='?display=adminlogs&page=".($page-1)."'>Previous Page</a> | "; else $pagenav.="Previous Page | ";
		if(($page+1)*$limit<$total) $pagenav.= "<a href='?display=adminlogs&page=".($page+1)."'>Next Page</a>"; else $pagenav.="Next Page";
		...
		$logs = mysql_query("SELECT * FROM logs ORDER BY time DESC LIMIT ".($page*$limit).",".$limit);
